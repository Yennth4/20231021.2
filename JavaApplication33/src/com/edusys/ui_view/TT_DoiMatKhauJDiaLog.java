...
public class TT_DoiMatKhauJDiaLog extends javax.swing.JDialog {
    ...
    public TT_DoiMatKhauJDiaLog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        MsgBox.alter(this, "Đã đóng cửa sổ Đổi Mật Khẩu!!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TT_DoiMatKhauJDiaLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TT_DoiMatKhauJDiaLog dialog = new TT_DoiMatKhauJDiaLog(new javax.swing.JFrame(), true);
